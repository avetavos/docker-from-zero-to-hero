...
- เรียง instruction ที่เปลี่ยนบ่อย (เช่น คัดลอก source) ไว้บนสุด ทำให้ layer ที่ควรเปลี่ยนน้อยอยู่ใต้มันเสียค่าตามไปด้วย
