---
title: 'network Bridge เริ่มต้น'
description: 'วิธีการทำงานของ default bridge network, IP ของ container, การแยก network และเหตุใดจึงไม่มี DNS'
sidebar:
  order: 2
---
...
export const bridgeDiagram = `flowchart TB
  host["Host"]
...
<Mermaid code={bridgeDiagram} title="Containers attached to the default docker0 bridge" />
