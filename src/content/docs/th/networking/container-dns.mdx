...
สร้าง network ด้วย `docker network create` และเชื่อมต่อ container ด้วย `--network` Container ที่อยู่บน user-defined bridge เดียวกันจะ resolve ชื่อ container ของกันและกันได้โดยอัตโนมัติ
</Callout>
