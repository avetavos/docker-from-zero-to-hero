...
export const imageRefDiagram = `flowchart TB
...
export const runFlowDiagram = `flowchart TB
...
<Mermaid code={imageRefDiagram} title="Anatomy of an image reference" />
...
<Mermaid code={runFlowDiagram} title="What happens when you run docker run" />
...
export const quizWhatIsDocker = [
  {
    ...
    options: [
      ...
      "มันคือ server ที่จัดเก็บและแจกจ่าย images สาธารณะ",
  ...
  },
  {
    ...
    options: [
      "instance ที่กำลังรันของ application ที่มี kernel เป็นของตัวเอง",
