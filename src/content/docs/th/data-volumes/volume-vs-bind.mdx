...
mental model ง่ายๆ: ถ้าต้องการให้ข้อมูลรอดชีวิตจาก container และย้ายระหว่าง environment ใช้ named volume ถ้าต้องการให้ host และ container แชร์ view ของไฟล์เดิมแบบ live ระหว่างการพัฒนา ใช้ bind mount ใน production ให้เลือก named volumes เพราะพกพาได้ Docker จัดการให้ และสำรองข้อมูลได้ง่ายกว่า
</Callout>
