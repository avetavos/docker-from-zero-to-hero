...
<Callout title="exec รัน process ใหม่ — ไม่ใช่ container ใหม่">
`docker exec` เริ่ม **process ใหม่** ภายใน container ที่มีอยู่ซึ่งกำลังทำงานอยู่ ไม่ได้สร้าง container ที่สอง เมื่อคุณ exit จาก shell container จะยังคงทำงานต่อด้วย process หลักเดิม
</Callout>
...
export const quizExecLogs = [
  ...
  },
  {
    ...
    options: [
      "Container หยุดทำงาน",
      "Container ถูกลบ",
      "Container ยังทำงานต่อ — เฉพาะ process exec สิ้นสุด",
      "Container รีสตาร์ท"
    ],
    answer: 2
  },
