...
> 💡 Real World Example
>
> Binary ที่ compile แบบ static ด้วย Go หรือ Rust แล้วรันบน `distroless` หรือ `scratch` base image มักได้ production image สุดท้ายต่ำกว่า 20MB เป็นประจำ ซึ่งเป็น pattern ที่ Google แนะนำและ publish เองผ่าน `gcr.io/distroless`
...
export const quizMultiStage = [
  ...
  },
  {
    ...
    options: [
      ...
      "scratch ปิดการใช้งาน network เพื่อความปลอดภัย",
