...
Copy dependency manifest (`package.json`, `go.mod`, `requirements.txt`) และ install dependencies ก่อนที่จะ copy source code ของ application การเปลี่ยนแปลงเพียงอย่างเดียวนี้ทำให้ layer การ install dependency สามารถ cache ได้สำหรับ build ส่วนใหญ่ในการพัฒนาแบบ iterative ซึ่งประหยัดเวลาได้มากในโปรเจกต์ที่มีการพัฒนาต่อเนื่อง
</Callout>
