...
ทุก package ที่ติดตั้งใน Docker image คือช่องโหว่ที่อาจเกิดขึ้นได้ การทำให้ image เล็กไม่ใช่แค่เรื่องความเร็ว แต่ยังช่วยลดจำนวน component ที่ต้องได้รับการ patch, scan และ maintain runtime image ควรมีเฉพาะสิ่งที่ application ต้องการ ไม่มากไปกว่านั้น
</Callout>
