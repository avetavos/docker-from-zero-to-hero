...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      head: [
        { tag: 'script', attrs: { type: 'module', src: '/docker/enhance.js' } },
        { tag: 'link', attrs: { rel: 'manifest', href: '/docker/manifest.webmanifest' } },
        { tag: 'link', attrs: { rel: 'apple-touch-icon', href: '/docker/apple-touch-icon.png' } },
        { tag: 'link', attrs: { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/docker/icon-192.png' } },
        ...
        { tag: 'script', content: "if('serviceWorker' in navigator){window.addEventListener('load',function(){navigator.serviceWorker.register('/docker/sw.js',{scope:'/docker/'}).catch(function(){})})}" },
      ],
      defaultLocale: 'en',
      locales: {
