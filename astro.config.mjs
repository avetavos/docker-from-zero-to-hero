...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        { label: 'Intro & Concepts', collapsed: true, items: [{ autogenerate: { directory: 'intro' } }] },
        { label: 'Images & the Dockerfile', collapsed: true, items: [{ autogenerate: { directory: 'images-dockerfile' } }] },
        { label: 'Running Containers', collapsed: true, items: [{ autogenerate: { directory: 'containers' } }] },
        { label: 'Data & Volumes', collapsed: true, items: [{ autogenerate: { directory: 'data-volumes' } }] },
        { label: 'Networking', collapsed: true, items: [{ autogenerate: { directory: 'networking' } }] },
        { label: 'Docker Compose', collapsed: true, items: [{ autogenerate: { directory: 'compose' } }] },
        { label: 'Optimization & Best Practices', collapsed: true, items: [{ autogenerate: { directory: 'optimization' } }] },
        { label: 'Registry, CI & Deploy', collapsed: true, items: [{ autogenerate: { directory: 'registry-ci-deploy' } }] },
      ],
      }), preact()],
});